-- IF NOT EXISTS / DO block: o DB de preview compartilhado já recebeu esta tabela do build de
-- preview do #515 quando ela era a 0046 (renumerada após o merge da 0046_enable_kelly_staking).
...
DO $$
BEGIN
	ALTER TABLE "league_settings" ADD CONSTRAINT "league_settings_updated_by_user_id_users_id_fk" FOREIGN KEY ("updated_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
...
-- EXISTENTE com 0045 e esta pendentes juntas (num DB novo o tipo nasce na mesma transação e o
