...
export function AnalysisResult({ view }: Props) {
  ...
  if (view.recommendation === null) {
    return (
      <div className="flex flex-col rounded-lg border border-dashed border-border-strong bg-card">
        <div className="flex items-center justify-between px-4 pt-3 pb-2">
          <span className="flex items-center gap-1 font-mono text-eyebrow uppercase tracking-eyebrow text-muted-foreground">
            sem edge claro
            <HelpHint
              anchor="recomendacao"
        ...
        <div className="flex items-start gap-4 px-4 py-4">
          <div className="flex flex-col items-start gap-1">
            <span className="font-mono text-display-sm font-medium tabular-nums leading-none tracking-tight text-muted-foreground">
              PASS
            </span>
        ...
        <p className="px-4 pb-4 text-body-sm leading-relaxed tracking-tight text-muted-foreground">
        ...
        <div className="px-4 py-3">
          <p className="text-body-sm leading-relaxed text-foreground tracking-tight">
            {view.rationale}
          </p>
  ...
  return (
    <Card className="gap-0 overflow-hidden p-0">
      <div className="flex items-center justify-between px-4 pt-3 pb-2">
        <span className="font-mono text-eyebrow uppercase tracking-eyebrow text-accent-fg">
      ...
      <div className="flex items-start gap-3 px-4 py-4">
        <div className="flex flex-col items-start gap-1">
          <span className="font-mono text-display-md font-medium leading-none tracking-tight text-accent-strong-fg">
            {rec.selectionLabel}
            {rec.line !== null ? ` ${rec.line}` : ""}
          </span>
          <span className="font-mono text-eyebrow uppercase tracking-label text-accent-fg">
            {rec.marketLabel}
          </span>
        </div>
      </div>
      {rec && (
        <div className="mx-4 mb-4 flex flex-col gap-2 rounded-md border border-border-subtle bg-surface-2 px-3 py-2.5">
          ...
          <p className="text-body font-medium leading-snug tracking-tight text-foreground">
          ...
          {rec.betSummary && (
            <p className="text-body-sm leading-snug tracking-tight text-muted-foreground">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex items-baseline justify-between gap-2">
              ...
              <span
                className={cn(
                  "font-mono text-body font-medium tabular-nums tracking-tight",
            ...
            {view.evLegend && (
              <p className="text-meta leading-snug tracking-tight text-muted-fg-2">
                {view.evLegend}
              </p>
            )}
          </div>
          {view.minOdd && (
            <div className="flex items-baseline justify-between gap-2 border-t border-border-subtle pt-2">
              ...
              <span className="font-mono text-label font-medium tabular-nums tracking-tight">
                {view.minOdd}
              </span>
            </div>
          )}
  ...
  return (
    <ul className="flex flex-col gap-2 pt-4">
      ...
      {items.map((f, i) => (
        <li
          key={i}
          className="flex items-start gap-1.5 text-body-sm text-foreground tracking-tight"
        >
          <Dot className="-ml-1 size-4 shrink-0 text-muted-fg-2" aria-hidden="true" />
